      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto p-4">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Your <span style={{color: '#87CEEB', fontWeight: 700, fontFamily: 'serif', letterSpacing: '0.02em'}}>regalcare</span> Benefits</h1>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-2xl mx-auto p-4">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Complete your <span style={{color: '#87CEEB', fontWeight: 700, fontFamily: 'serif', letterSpacing: '0.02em'}}>regalcare</span> subscription</p>
          </div>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-center p-4">
          ...
          <CardHeader>
            ...
            <CardTitle className="text-2xl text-green-600">Welcome to <span style={{color: '#87CEEB', fontWeight: 700, fontFamily: 'serif', letterSpacing: '0.02em'}}>regalcare</span>!</CardTitle>
